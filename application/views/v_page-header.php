...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white">
		<div class="container">
			<a class="navbar-brand" href="#"><img src="assets/img/logo-header.png" width="150px;"
					class="main-logo img-responsive"></a>
		...
		<div class="jumbotron jumbotron-fluid bg-danger w-5">
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner bg-danger">
                            <div class="carousel-item active justify-justify-content-center mr-3">
                                <div class="row">
                                    <div class="col-lg-4">
			...
			<div class="row justify-content-center">
				<div class="col-md-5 ws-home-check-left">
					<div class="ws-home-check-title-left pt-4">
						<img class="check-fee-icon" src="<?= base_url('assets/img/cek-ongkir@2x.png') ?>"
							style="margin-right: 17px; margin-bottom: 4px;">Cek Tarif
					</div>
					...
					<form action="#" class="ws-form form-horizontal check-form" method="post" accept-charset="utf-8">
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<input id="origin" type="text" value="" name="origin" class="form-control px-2"
									placeholder="Select province" autocomplete="off">
							</div>
						</div>
						...
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<input id="destination" type="text" value="" name="destination" class="form-control"
									placeholder="Select province" autocomplete="off">
							</div>
						</div>
						<input id="destination_code" type="hidden" value="" name="destination_code"
							class="form-control">
						...
						<div class="row">
							<div class="col-md-12 text-right"><a id="btn-check" name="btn-check" class=" btn btn-check"
									href="javascript:void(0)">Cek Harga</a>
							</div>
						</div>
					</form>
				...
				<div class="col-md-5 col-md-offset-2 ws-home-check-right">
					<div class="ws-home-check-title-right pt-4">
						<img class="check-awb-icon" src="assets/img/location@2x.png"
							style="margin-right: 17px; margin-bottom: 4px;">Track Resi
					</div>

					<form action="#" class="ws-form form-horizontal ws-full-lbl track-form" id="track-form"
						method="POST" accept-charset="utf-8">
						<div class="row">
							<div class="col-md-12 pt-3">
								<textarea id="textarea-awb" name="textarea-awb" class="form-control" cols=""
									rows=""></textarea>
					...
					<div class="row text-right">
						<div class="col-md-12">
							<a id="btn-track" name="btn-track" class=" btn btn-track"
								href="javascript:void(0)">Lacak</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="container">
		...
		<div class="__sub-title text-center">
			<span>
				SiCepat berkomitmen menjadi partner terpercaya di seluruh Indonesia. Inilah 10 alasan tepat untuk
				memilih SiCepat.......
			</span>
		</div>
	</div>
	...
	<div class="ws-home-service">
		<div class="container">
			...
			<div class="__sub-title text-center">
				<span>SiCepat menyediakan beberapa layanan untuk mendukung bisnis kamu. Dapatkan layanan tepat yang
					sesuai dengan kebutuhan kamu</span>
			</div>
			...
			<div class="service-content">
					...
					<div class="col-md-12 pr-3 item-service text-center">
						...
						<div class="service-item mr-3">
							...
							<div class="service-item-info">
								...
								<div class="service-item-line"></div>
								<div class="service-item-title2">Transaksi belanja dengan pembayaran<br>cash pada saat
									barang diterima</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-md-12 mb-5 text-center">
						<a id="btn-show-service" name="btn-show-service" class=" btn btn-show-service" href="#">Lihat
							Detail</a>
					</div>
				</div>
			</div>
	...
	<div class="row bg-light">
		...
		<div class="col-md-6 text-center ws-join-right">
			<button id="btn-join" name="btn-join" class=" btn btn-join" href="javascript:void(0)"><b>Gabung
					Sekarang</b></button>
		</div>
	</div>
			...
			<div class="container">
						...
						<div class="row">
							<div class="col-md-3" style="width:30%;">
								...
								<ul class="ws-menu-list">
									...
									<li><a href="http://sicepat.com/statusSicepat">Kode Status Pengantaran Paket</a>
									</li>
							...
							<div class="col-md-2" style="width:17%;">
								...
								<ul class="ws-menu-list">
									...
									<li><a href="https://www.youtube.com/channel/UC9DIPyaNoShFJ5oKsrv7AVg">Youtube</a>
									</li>
								</ul>
							</div>
							<div class="col-md-3" style="width:30%;">
								...
								<table class="contact-address-list">
									<tbody>
										<tr>
											<td><img class="footer-icon"
													src="http://sicepat.com/application/websicepat/assets/img/address-loc-white@2x.png">
											</td>
											<td>Jl. Ir. H. Juanda 3 No. 17-19, RT.008/RW.002, Kel. Kebon Kelapa Kec.
												Gambir, Jakarta Pusat 10120</td>
										</tr>
										<tr>
											<td><img class="footer-icon"
													src="http://sicepat.com/application/websicepat/assets/img/phone-white@2x.png">
											</td>
											<td>021-5020-0050</td>
										</tr>
										<tr>
											<td><img class="footer-icon"
													src="http://sicepat.com/application/websicepat/assets/img/line-white@2x.png">
											</td>
											<td>@sicepat</td>
										</tr>
										<tr>
											<td><img class="footer-icon"
													src="http://sicepat.com/application/websicepat/assets/img/message-white@2x.png">
											</td>
					...
					<div class="col-md-2 text-right">
						...
						<div class="row ws-store-menu">
							<div class="col-md-12 mb-2 ws-store-play">
								<a href="https://play.google.com/store/apps/details?id=com.sicepat.android.pelanggan"
									target="blank">
									<img class="store-icon"
										src="http://sicepat.com/application/websicepat/assets/img/playstore@2x.png">
								</a>
							</div>
							<div class="col-md-12 pt-2 ws-store-app">
								<a href="https://itunes.apple.com/id/app/sicepat-express/id1037417977?l=id&amp;mt=8"
									target="blank">
									<img class="store-icon"
										src="http://sicepat.com/application/websicepat/assets/img/appstore@2x.png">
								</a>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12 mb-4 ws-footer-bottom">
						<i class="fa fa-copyright"></i> 2018 PT. SiCepat Ekspres Indonesia. All rights reserved. 2018
						PT. SiCepat Ekspres Indonesia. All rights reserved.
					</div>
				</div>
			</div>
		</div>
