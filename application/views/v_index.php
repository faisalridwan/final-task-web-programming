            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link bg-danger active " href="<?= base_url(); ?>">HOME </a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-5 col-md-offset-2 ws-home-check-right">
                        <div class="ws-home-check-title-right pt-4">
                            <img class="check-awb-icon" src="<?= base_url('assets/img/location@2x.png')?>" style="margin-right: 17px; margin-bottom: 4px;">Track Resi
                        </div>
